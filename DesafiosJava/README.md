...
***Divisores*** :computer::interrobang::heavy_check_mark:
...
- Será que, conhecendo os números **A**, **B**, **C** e **D**, você consegue descobrir qual era o número original ***n***? Note que pode existir mais de uma solução!
...
- Caso exista pelo menos um número n para os quais A, B, C e D façam sentido, a linha deve conter o menor n possível. 
- Caso contrário, a linha deve conter -1.



***Análise de Números*** :computer::interrobang::heavy_check_mark:
...
***Contagem repetida de números*** :computer::interrobang::heavy_check_mark:
